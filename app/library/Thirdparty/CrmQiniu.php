...
class Thirdparty_CrmQiniu
{
    ...
    private $url;
    private $domain    = "http://prime-resources.aiqingtijian.com";
    private $headers;
    private $body;
    private $method;
     ...
     * @return type
     */
    public function uploadToken($args = [],$bucket)
    {
        $deadline = time() + $this->expires;

        $scope = !empty($bucket)?trim($bucket):$this->bucket;
        $params = [];
        $params['scope'] = $scope;
